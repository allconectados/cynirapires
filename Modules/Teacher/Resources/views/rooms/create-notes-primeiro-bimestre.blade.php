...
@section('content')
    ...
    <form action="{{route('teacher.disciplines.notes.store')}}" method="post">
        @csrf
                        ...
                        @foreach($students->sortBy('number') as $student)
                            ...
                            <tr>
                                <td class="text-truncate text-center">
                                    ...
                                    @else
                                        <span class="text-danger">{{$student->number}}</span>
                                    @endif
                                </td>
                                ...
                                <td class="text-truncate text-center" contenteditable="true">
                                    <input type="text" style="max-width: 3rem" name="bimestre_one_note[]"
                                           value="{{old('bimestre_one_note')}}" tabindex="1">
                                </td>
                                <td class="text-truncate text-center" contenteditable="true">
                                ...
                                <td class="text-truncate text-center" contenteditable="true">
                                    <input type="text" style="max-width: 3rem" name="total_faltas[]"
