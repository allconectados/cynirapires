                        ...
                        @foreach($studentsNote->sortBy('number') as $student)
                            ...
                            <tr>
                                ...
                                <td class="text-truncate text-center" contenteditable="true">
                                    @if($student->nota >= 5)
                                        <input type="number" style="max-width: 4rem" name="nota[]" class="table-target"
                                               value="{{$student->nota, old('nota')}}" tabindex="1" step='0.5' min="0"
                                               max="10">
                                    @else
                                ...
                                <td class="text-truncate text-center" contenteditable="true">
                                    <input type="number" style="max-width: 4rem" name="nota_participation[]"
                                           ...
                                           tabindex="2" step='0.5' min="0" max="10">
                                </td>

                                <td class="text-truncate text-center" contenteditable="true">
                                    @if($student->nota !== null)
                                        @if($student->nota_final >= 5)
                                            <input type="number" style="max-width: 4rem" name="nota_final[]"
                                                   class="table-target"
                                                   value="{{$student->nota + $student->nota_participation}}"
                                                   step='0.5' min="0" max="10" readonly>
                                        @else
                                            <input type="number" style="max-width: 4rem" name="nota_final[]"
                                                   class="table-target"
                                                   value="{{$student->nota + $student->nota_participation}}"
                                    ...
                                    @else
                                        <input type="number" style="max-width: 4rem" name="nota_final[]"
                                               class="table-target" value=""
                                               step='0.5' min="0" max="10" readonly>
                                    @endif
                                </td>

                                <td class="text-truncate text-center" contenteditable="true">
                                    <input type="number" style="max-width: 4rem" name="falta[]" class="table-target"
