    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                @include('proatec::teachers._forms.import')
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                @include('proatec::teachers._forms.create')
            </div>
        </div>
    </div>
    <div class="container">
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 1.0rem">
                                        <a href="{{route('modules.teachers.edit', $item->id)}}"
                                           class="btn btn-warning btn-sm">
                                            <i class="fas fa-pen-square"></i>
                                        </a>
                                    </td>
                                    <form action="{{route('modules.teachers.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <td class="text-center" style="width: 1.0rem">
