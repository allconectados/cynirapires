...
use Modules\Coordination\Http\Requests\DisciplineStoreFormRequest;
use Modules\Coordination\Http\Requests\DisciplineUpdateFormRequest;
use Modules\Coordination\Imports\DisciplineImport;
...
class DisciplineController extends Controller
{
    ...
    public function index($year, $stage, $serie, $room)
    {
        ...
        return view('coordination::disciplines.index', compact('titlePage','year', 'stage', 'serie', 'room', 'disciplines'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('coordination::disciplines.edit', compact('titlePage', 'item', 'teachers'));
    }
