    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                @include('coordination::disciplines._forms.import')
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                @include('coordination::disciplines._forms.create')
            </div>
        </div>
    </div>
    <div class="container">
                ...
                <div class="table-responsive">
                    <div class="table-responsive table-bordered table-hover">
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 1.0rem">
                                        <a href="{{route('coordinations.disciplines.edit', $item->id)}}"
                                ...
                                @include('coordination::disciplines._modals.destroy', ['item' => $item])
                            @endforeach
                            </tbody>
                        </table>
                        <br>
                        <div class="container-fluid">
                            <div class="d-flex">
                                <div class="mx-auto">
                                    @include('coordination::partials._index_paginate')
                                </div>
                            </div>
                        </div>
                    </div>
